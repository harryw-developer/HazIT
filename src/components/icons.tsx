...
// Website enquiries (contact-form messages)
export function EnquiriesIcon({ size = 64 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" aria-hidden>
      <rect width="64" height="64" rx="14" fill="#0d9488" />
      <rect x="12" y="19" width="40" height="27" rx="3" fill="#fff" />
      <path d="M13.5 21.5 32 34l18.5-12.5" stroke="#0d9488" strokeWidth="3" fill="none" strokeLinecap="round" strokeLinejoin="round" />
      <circle cx="49" cy="19" r="7.5" fill="#f43f5e" stroke="#fff" strokeWidth="2.5" />
    </svg>
  )
}
